...
import com.imooc.wx.entity.SysRequestPath;
import com.imooc.wx.mapper.SysRequsetPathMapper;
import com.imooc.wx.service.SysRequestPathService;
...
public class SysRequestPathServiceImpl implements SysRequestPathService {
    @Resource
    private SysRequsetPathMapper sysRequsetPathMapper;
    ...
    public SysRequestPath queryById(Integer id) {
        return this.sysRequsetPathMapper.queryById(id);
    }
    ...
    public List<SysRequestPath> queryAllByLimit(int offset, int limit) {
        return this.sysRequsetPathMapper.queryAllByLimit(offset, limit);
    }
    ...
    public SysRequestPath insert(SysRequestPath sysRequestPath) {
        this.sysRequsetPathMapper.insert(sysRequestPath);
    ...
    public SysRequestPath update(SysRequestPath sysRequestPath) {
        this.sysRequsetPathMapper.update(sysRequestPath);
    ...
    public boolean deleteById(Integer id) {
        return this.sysRequsetPathMapper.deleteById(id) > 0;
    }
}
